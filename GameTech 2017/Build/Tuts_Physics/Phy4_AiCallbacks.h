...
public:
	...
	virtual void OnInitializeScene() override
	{
		...
		this->RegisterOnUpdateCallback(city2, [city2](float dt)
		{
			city2->Render()->SetColorRecursive(Vector4(1.f, 0.f, 1.f, 1.f));
		});


		//Test Cube
		this->AddGameObject(CommonUtils::BuildCuboidObject("cube1",
			Vector3(-9.0f, 0.5f, -9.0f),			//Position leading to 0.25 meter overlap between spheres
		...
		this->FindGameObject("cube1")->Physics()->SetOnCollisionCallback(&Phy4_AiCallbacks::ExampleCallbackFunction3);
	...
	bool ExampleCallbackFunction2(PhysicsNode* self, PhysicsNode* collidingObject)
	{
		...
		self->GetParent()->Render()->SetColorRecursive(Vector4(0.0f, 1.0f, 0.0f, 0.5f));
	...
	static bool ExampleCallbackFunction3(PhysicsNode* self, PhysicsNode* collidingObject) {

		NCLDebug::Log(Vector3(0.3f, 1.0f, 0.3f), "Player Collides with TestCube! - Static callback");
