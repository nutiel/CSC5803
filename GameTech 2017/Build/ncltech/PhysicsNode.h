...
public:
	...
	void SetBoundingRad(Vector3 halfdim) {

		////////wrong, the corners of a box are left out////////

		boundingVol = max(halfdim.x, max(halfdim.y, halfdim.z));
	}

	float getBoundingRad() { return boundingVol; }
